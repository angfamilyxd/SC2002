 ...
 */
public class MovieGoerSeatingView extends StartView {
     ...
     */
    public MovieGoerSeatingView(ShowTime showtime){
    ...
    public void activate() {
        ...
        FileInputOutputOperator.printMenuOptions(options);
    ...
    private void handleBookSeat(){
        ...
        while (true){
            try{
                ...
                String userChosenSeat = FileInputOutputOperator.getUserInputString("");
            ...
            userProceedChoice = FileInputOutputOperator.getUserInputInt("Please input a choice",1,choices.size());
        ...
        if (userProceedChoice == 4){
            ...
            ViewOperator.pushView(new MovieGoerPurchaseView(this.chosenSeats,this.showtime));
        }
