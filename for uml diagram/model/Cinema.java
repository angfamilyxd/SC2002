...
public class Cinema implements Serializable {
     ...
     */
	private CinemaClassType cinemaClass;
	 ...
	 */
	public Cinema(Cineplex cineplex, CinemaClassType cinemaClass, int code,SeatLayout seatLayout) {
	...
	/*
	public Cinema(CinemaClassType cinemaClass, int code,SeatLayout seatLayout) {
		this.cinemaClass = cinemaClass;
		this.code = code;
		this.seatLayout = seatLayout;
	}
	*/
	 ...
	 */
	public CinemaClassType getCinemaClass() {
	 ...
	 */
	public void setClass(CinemaClassType c) {
		cinemaClass = c;
	}
