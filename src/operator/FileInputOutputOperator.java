...
public class FileInputOutputOperator {
	...
	public static <E> void printMultipageOptions(ArrayList<E> array,int numOfOptionsPerPage,String endOptionsChoosingSessionMessage) {
		...
		while (true) {
			...
			int userChoice = FileInputOutputOperator.getUserInputInt("Please choose an option: ",1,userChoices.size());
	...
	public static <E> int printMultipageOptionsWithReturnedChoice(ArrayList<E> array,int numOfOptionsPerPage) {
		...
		while (true) {
			...
			if (userChoice == 1) {
				int start = 1;
				int end = array.size();
				return FileInputOutputOperator.getUserInputInt("Input your choice: ",start,end);
			}else if (userChoice == 2) {
				return -1;
			}
	...
	public static LocalDate getUserInputDate(String message){
		...
		try{
			...
			String userDate = FileInputOutputOperator.getUserInputString("");
