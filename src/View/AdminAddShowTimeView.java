...
public class AdminAddShowTimeView extends BaseView {
     ...
     */
    private String title = "Admin: Add/Remove Showtime for: ";
    ...
    private void handleGettingInfo(){
        ...
        chosenDate = IOManager.getUserInputDate("Please input a date that you want to insert the showtime to: ");
    }
    ...
    private void handleAddShowTime(){
        ...
        int typeChoice = IOManager.getUserInputInt("Enter the choice: ",1,movieTypeListStrings.size());
        ...
        System.out.println("Proceed to save?");
